...
# Annotation file
#ANNOTATION_FILE="/workspaces/Yasmine-retroT/0_Data/ref/ref_genome/GCF_000001635.27_GRCm39_genomic.gtf"
ANNOTATION_FILE="/workspaces/Yasmine-retroT/0_Data/ref/ref_genome/GRCm39_RefSeqAcc_rmsk_TE.gtf.gz"
